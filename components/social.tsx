...
export const Sociallinks = () => {
    return (
        <div className="flex md:space-x-6 justify-evenly md:w-max w-screen">
            ...
            <div className="rounded-xl pl-10 pb-10 pt-2 mr-1 pr-2 border-2 bg-blue-100 dark:bg-inherit"><Link href="https://www.instagram.com/ankush__57s/" /><FaInstagram color="red" size={30} /></div>
        </div>
    )
}