...
export default function Insta(){
    return (
        <div className="py-3 px-5 w-fit h-auto flex items-center justify-center flex-col space-y-2 dark:border-sky-400 border rounded-xl bg-gray-200 dark:bg-inherit">
