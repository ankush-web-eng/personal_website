...
export const Navbar = () => {
    ...
    return (
        ...
        <ul className="flex justify-evenly md:justify-center items-end fixed md:sticky top-0 md:flex-col md:py-2 py-3 md:my-2 md:space-y-10 md:h-screen md:w-1/5 max-sm:space-x-7 w-screen border-r dark:border-slate-800 z-50 backdrop-filter backdrop-blur-lg">
